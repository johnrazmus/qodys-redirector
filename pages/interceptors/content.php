...
<div class="wrap qody_only_area">
	...
	<div class="page-header">
		...
		<h2><?php echo $this->m_page_title; ?> <?php $this->DocLink('http://docs.qody.co/plugins/specific-products/alejandro-qodys-redirector/interceptor-pages/'); ?> <small><?php echo $this->Helper('tools')->Clean( $page_title ); ?></small></h2>
	</div>
